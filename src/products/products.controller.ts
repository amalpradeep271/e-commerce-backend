...
export class ProductsController {
  ...
  @ApiQuery({
    name: 'sort',
    required: false,
    description: 'Sorting criteria: top-selling or new-in',
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiResponse({
    status: 200,
    description: 'Returns list of user favorited products',
  })
  ...
  @UseGuards(JwtAuthGuard)
  @ApiOperation({
    summary: 'Add or remove a product from current user favorites',
  })
  @ApiResponse({
    status: 200,
    description:
      'Toggles favorite and returns new status (true=favorited, false=unfavorited)',
  })
